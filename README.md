...
Enables private methods be be added onto the prototype, keeping object memory to a minimum.

Keeps code creation clean and easy to read.

Cons
----

Creating protected objects is more expensive.

Object sizes are increased slightly due to the extra protection that has been added.
